...
public class TextoProductosToBinario {
    ...
    private static final String NOMBRE_ARCHIVO_ENTRADA_DAT_DEFAULT = "productos_entrada.dat";
    private static final String rutaFicheroDat = System.getProperty("user.dir") + File.separator + NOMBRE_ARCHIVO_ENTRADA_DAT_DEFAULT;
    ...
    public static void main(String[] args) {
        ...
        File ficheroSalida = new File(rutaFicheroDat);
        try(ObjectOutputStream salida = new ObjectOutputStream(new FileOutputStream(ficheroSalida))){
