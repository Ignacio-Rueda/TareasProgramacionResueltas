...
public class Actividad4 {
    ...
    final static private String rutaFicheroDat = System.getProperty("user.dir") + File.separator + "texto_encriptado_entrada.dat";
    ...
    public static void main(String[] args) {
        ...
        try(ObjectOutputStream salida = new ObjectOutputStream(new FileOutputStream(rutaFicheroDat))){
            salida.writeObject(listaEncriptada);
            salida.flush();
        }catch(FileNotFoundException ex){
            System.out.println(ex.getMessage());
        }catch(IOException ex){
